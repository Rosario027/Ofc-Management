...
export default function AdminDashboard() {
  ...
  const attendanceData = [
    { name: 'Mon', present: Math.floor(orgUsers.length * 0.9), absent: Math.floor(orgUsers.length * 0.1) },
    { name: 'Tue', present: Math.floor(orgUsers.length * 0.85), absent: Math.floor(orgUsers.length * 0.15) },
    { name: 'Wed', present: Math.floor(orgUsers.length * 0.9), absent: Math.floor(orgUsers.length * 0.1) },
    { name: 'Thu', present: Math.floor(orgUsers.length * 0.88), absent: Math.floor(orgUsers.length * 0.12) },
    { name: 'Fri', present: Math.floor(orgUsers.length * 0.82), absent: Math.floor(orgUsers.length * 0.18) },
  ];
